...
import { faEnvelope, faLocation, faLocationPin, faMailBulk, faMailForward, faMailReply, faVoicemail } from "@fortawesome/free-solid-svg-icons";
...
const [message, setMessage] = useState("");
    ...
    return(
        <div className="px-28 py-7">
            ...
            <div className="flex-1  inline-grid font-bold">
                    ...
                    <Link href={"mailto:freshencar@gmail.com"}>
                        ...
                        <span className="ml-4">freshencar@gmail.com</span></Link>
                    <div>
                        <FontAwesomeIcon icon={faLocationPin} />
                        <span className="ml-4">Cambyretá - Barrio San José, calle S/N casi Los Inmigrantes</span>
                    </div>
            </div>
            <div>
          ...
          <div className="py-5">
            <div className="flex flex-col">
              <div className="flex flex-col">
                ...
                />
                <textarea name="message" id="message" onChange={(e) => inputChange(e)} placeholder="Ej. su  mensaje"
